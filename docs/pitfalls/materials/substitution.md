...
- [1. How Material Substitutions Occur](#1-how-material-substitutions-occur)
- [2. Common Substitution Scenarios](#2-common-substitution-scenarios)
- [3. Quality Differences and Hidden Costs](#3-quality-differences-and-hidden-costs)
- [4. The Material Approval Process](#4-the-material-approval-process)
- [5. Cost Adjustment and Pricing Rules](#5-cost-adjustment-and-pricing-rules)
- [6. Detection and Inspection Guide](#6-detection-and-inspection-guide)
- [7. Contract Clauses for Protection](#7-contract-clauses-for-protection)
- [8. Material Substitution Checklist](#8-material-substitution-checklist)
...
- Related: [Material Inspection](/pitfalls/materials/inspection) — Detailed material quality inspection procedures
- Related: [Material Purchase](/pitfalls/materials/purchase) — Guide to purchasing renovation materials
- Related: [Material Storage](/pitfalls/materials/storage) — Proper storage of renovation materials on-site
- Related: [Contract Pitfalls](/pitfalls/contract/) — Contract clauses that protect material quality
